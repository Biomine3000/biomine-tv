...
import org.bm3k.abboe.objects.ContentVaultProxy.InvalidStateException;
...
public class ABBOEServer {
    ...
    private class ContentVaultListener implements org.bm3k.abboe.objects.ContentVaultProxy.ContentVaultListener {
